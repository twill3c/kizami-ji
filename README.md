...
**loop_010 完了。本番 https://kizami-ji.vercel.app が動いている。全 5 ページ。**
...
語彙を刈った実験(「痩せた辞書」)では、**語数ではなく どの語を持つかが効く**と分かった。
辞書ゼロ(文字種の規則だけ)で境界 F1 0.7265、**無作為に 1,000 語積んでも 0.7264**、
頻度上位 1,000 語なら 0.9099。無作為の語は使われていないのではなく、
85,249 トークン中 460 に使われたうえで効かない。
